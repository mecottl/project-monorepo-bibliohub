...
import { COLOR_PRIMARIO, gradienteArea, moneda, monedaCorta } from '@shared/ui/chart/tremor-theme';
import { ReportesService } from '@domain/reportes/reportes.service';
import { LibroMasVendido, VentasPorDia } from '@domain/reportes/reporte.model';
