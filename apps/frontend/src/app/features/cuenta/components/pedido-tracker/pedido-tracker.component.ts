...
import { EstadoPedidoLinea, TipoEntrega } from '@domain/pedidos/pedido.model';
import { ETIQUETAS_ESTADO, pasosRastreo } from '@domain/pedidos/pedido-estado';
...
@Component({
  ...
  styles: `
    ...
    .tracker li.is-done:not(:first-child)::before,
    .tracker li.is-current:not(:first-child)::before {
