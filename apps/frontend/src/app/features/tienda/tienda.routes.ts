...
export const TIENDA_ROUTES: Routes = [
  { path: 'categorias', loadComponent: () => import('./pages/libros/libros.page').then((m) => m.LibrosPage) },
  ...
  },
  {
    ...
    loadComponent: () => import('./pages/lista-deseos/lista-deseos.page').then((m) => m.ListaDeseosPage)
  },
  {
    path: 'carrito',
    canActivate: [authGuard],
  ...
  },
  {
    ...
    canActivate: [authGuard],
    loadComponent: () =>
      import('./pages/pedido-confirmado/pedido-confirmado.page').then((m) => m.PedidoConfirmadoPage)
  }
];
