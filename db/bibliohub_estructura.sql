...
--
-- Name: calcular_totales_pedido(uuid, character varying, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.calcular_totales_pedido(p_cliente_id uuid, p_tipo_entrega character varying, p_puntos_usados integer) RETURNS TABLE(subtotal numeric, descuento_puntos numeric, costo_envio numeric, total numeric, puntos_ganados integer)
